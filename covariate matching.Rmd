...
```
Match on mine: 5160 matched points from original dataset of 12075
Match on indig: 3488 matched points from original dataset of 12075
...
```
Match on mine: 2576 matched points from original dataset of 5230
Match on indig: 1228 matched points from original dataset of 5230
...
nrow(match_unrecog_df%>%filter(stratum == "mine"))/nrow(test%>%filter(landmark_community == 1 & !is.na(treatment_unrecog) & stratum == "mine"))

table(match_unrecog_df$stratum)
```
Match on mine: 1740 matched points from original dataset of 4439
Match on indig: 430 matched points from original dataset of 4439
